  ...
  class ProjectDetails < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'primary_products')
        self.primary_products = attributes[:'primary_products']
      end
    ...
    def hash
      [id, name, brand_name, url, description, matching_names, industry, business_model, primary_products, target_audience, brand_voice, country_code, language_code, paused, google_play_id, app_store_id, created_at, stats].hash
    end
