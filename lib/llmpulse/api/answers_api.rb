...
module LLMPulse
  class AnswersApi
    ...
    # @option opts [Boolean] :no_result Filter sentinel non-answers (provider returned nothing after retries; excluded from platform metrics). false &#x3D; only real answers, true &#x3D; only sentinels, omit &#x3D; both. Every item carries its own no_result flag.
    # @return [nil]
    ...
    def list_answers_with_http_info(project_id, opts = {})
      ...
      query_params[:'no_result'] = opts[:'no_result'] if !opts[:'no_result'].nil?
