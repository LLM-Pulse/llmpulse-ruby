...
module LLMPulse
  class WebhooksApi
    ...
    def sample_webhook_payloads_with_http_info(event_type, project_id, opts = {})
      ...
      # verify enum value
      allowable_values = ["mention.created", "competitor_mention.created", "citation.created", "prompt_execution.completed", "sentiment.negative_detected", "recommendation.completed", "intelligence_task.completed"]
